...
#ifndef _V8_MEDIA_SERVER_H_
#define _V8_MEDIA_SERVER_H_
...
/*----------------------------------------------------------------------
|   V8MediaServerDelegate
+---------------------------------------------------------------------*/
/**
 File Media Server Delegate.
 The V8MediaServerDelegate class is an example of a PLT_MediaServerDelegate
 implementation for a file system backed Media Server.
 */
class V8MediaServerDelegate : public PLT_MediaServerDelegate
{
public:
    // class methods
    ...
    V8MediaServerDelegate(const char* url_root, const char* file_root,
		    Handle<Object> o,
		    bool use_cache = false);
    virtual ~V8MediaServerDelegate();
...
/**
 File Media Server.
 The V8MediaServer class is an example of a PLT_MediaServer implementation
 for a file system backed Media Server.
 */
class V8MediaServer : public PLT_MediaServer,
                            public V8MediaServerDelegate
{
public:    // constructor
    V8MediaServer(const char*  file_root,
		    Handle<Object> o,
        ...
        PLT_MediaServer(friendly_name, 
                        ...
                        port,
                        port_rebind),
        V8MediaServerDelegate("/", file_root, o) {SetDelegate(this);}

protected:
    virtual ~V8MediaServer() {}
};

#endif /* _V8_MEDIA_SERVER_H_ */
